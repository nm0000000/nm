# РЕАЛИЗАЦИЯ БИНОМИНАЛЬНОЙ КУЧИ НА PYTHON

# Реализация биноминальной кучи с помощью модуля heapq
import heapq 
someNumbers = [9, 4, 6, 2, 7, 3, 5, 8]  # создание списка с исходными данными для кучи 
heapq.heapify(someNumbers) # превращение списка в кучу 
heapq.heappush(someNumbers, 1) # добавление нового элемента в кучу 
...
# РЕАЛИЗАЦИЯ КУЧИ ФИБОНАЧЧИ НА PYTHON
# печать ряда Фибоначчи до заданного количества элементов:
...
# Create a hash table of size 15
hash_table = HashTable(15)

# Add some key-value pairs
hash_table.set('Alex', 'April')
hash_table.set('Maria', 'September')

# Retrieve a value
print(hash_table.get('Alex'))  # Outputs: 'April'

# Remove a key-value pair
hash_table.remove('Maria')

# This will raise a KeyError, as 'Maria' was removed
try:
    print(hash_table.get('Maria'))
